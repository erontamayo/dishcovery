...
const NAV_ITEMS = [
  {
    label: 'Dashboard',
    href: '/dashboard',
    description: 'Return to your personalized cooking dashboard.'
  },
  {
    label: 'Recipes',
    href: '/recipe',
    description: 'Explore recipes tailored to your tastes.'
  },
  {
    label: 'Pantry',
    href: '/pantry-search',
    description: 'Find meals using ingredients you already have.'
  },
  {
    label: 'Techniques',
    href: '/techniques',
    description: 'Learn essential cooking skills and methods.'
  },
  {
    label: 'Allergen & Diet',
    href: '/filters',
    description: 'Customize meals based on dietary restrictions.',
    active: true
  },
  {
    label: 'Journal',
    href: '/reflection-log',
    description: 'Track your cooking experiences and growth.'
  }
]
...
>
        ...
        {/* TOOLTIP ARROW */}
        <div className="absolute left-1/2 -bottom-1 w-2 h-2 bg-black rotate-45 -translate-x-1/2" />
    ...
    <div className="mb-10 bg-gradient-to-r from-[#44624a] to-[#5f7d65] rounded-[32px] p-10 text-white shadow-2xl overflow-hidden relative">
      ...
      <div className="absolute right-0 top-0 text-[200px] opacity-10 leading-none">
        🥗
      </div>
      ...
      <div className="relative z-10">
        ...
        <h1 className="text-5xl font-black leading-tight mb-5">
          Personalized Recipes For Every Diet
        </h1>

        <p className="text-lg text-white/80 max-w-2xl leading-relaxed">
          Discover AI-powered recipes tailored to your dietary preferences,
          allergens, and cravings.
        </p>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {selectedDietary.map((d) => {
            ...
            return (
              <span
                key={d}
                className="px-4 py-2 rounded-full bg-[#44624a]/10 text-[#44624a] text-sm font-medium"
              >
            ...
            <div className="p-8">
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                ...
                <div
                  className={`px-4 py-3 rounded-2xl font-bold text-sm ${
                    difficultyColors[selectedRecipe.difficulty] ||
              ...
              <div className="grid lg:grid-cols-2 gap-10">
                ...
                <div>
                  ...
                  <h3 className="text-3xl font-black text-[#2f3c33] mb-6">
                    Ingredients
                  </h3>
                  ...
                  <div className="space-y-3">
                    ...
                    {selectedRecipe.ingredients.map((ing, i) => (
                      ...
                      <div
                        key={i}
                        className="flex items-start gap-3 bg-[#fcfbf8] rounded-2xl p-4 border border-[#ece7df]"
                      >
                      ...
                      {steps.map((step, index) => (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="font-black text-[#44624a] mb-1">
                              Step {index + 1}
                            </p>
      ...
      <div className="lg:col-span-1">
        ...
        <div className="bg-white rounded-[28px] shadow-xl border border-[#ece7df] p-7 sticky top-28">
          ...
          <div className="mb-8">
            ...
            <h3 className="text-2xl font-black text-[#2f3c33] mb-5">
              Dietary Preferences
            </h3>
      ...
      <div className="lg:col-span-3">
        ...
        {isAISearching && (
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-gray-500">
              Dishi is searching for recipes...
            </span>
              ...
              >
                ...
                <div className="relative h-60 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold backdrop-blur ${
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-sm text-[#44624a] font-semibold uppercase tracking-wide">
                      {dish.category}
                    </span>
