...
<div className="mb-12 bg-gradient-to-r from-[#44624a] to-[#5f7d65] rounded-[32px] p-10 text-white shadow-2xl overflow-hidden relative">
  ...
  <div className="absolute top-0 right-0 opacity-10 text-[160px] leading-none">
    🥕
  </div>
  ...
  <div className="relative z-10">
    ...
    <p className="text-lg text-white/80 max-w-2xl">
      Select ingredients or let AI suggest dishes based on your pantry.
    </p>
                      ...
                      {steps.map((step, index) => (
                        ...
                        >
                          ...
                          <div className="flex gap-3">
                            ...
                            <div>
                              <p className="font-bold text-[#44624a]">
                                Step {index + 1}
                              </p>
              ...
              <div className="bg-white border border-gray-200 rounded-lg h-[700px] flex flex-col">
                ...
                <div className="border-t p-4 flex gap-2">
                  ...
                  <button
                    ...
                    className="bg-[#44624a] text-white p-2 rounded-lg"
                  >
...
<div className="lg:col-span-1">
  ...
  <div className="bg-white/90 backdrop-blur rounded-[28px] shadow-2xl border border-white/40 p-8 sticky top-28">
    ...
    <div className="flex items-center gap-3 mb-8">
      ...
      <div className="w-12 h-12 rounded-2xl bg-[#44624a] text-white flex items-center justify-center text-xl shadow-md">
        🧺
      </div>

      <div>
        <h2 className="text-2xl font-black text-[#2f3c33] leading-tight">
          Your Pantry
        </h2>
    ...
    {selectedIngredients.length > 0 && (
      <div className="flex flex-wrap gap-2 mb-5">
        ...
        {selectedIngredients.map((ingredient) => (
          <div
            key={ingredient}
            className="group flex items-center gap-2 bg-[#44624a] text-white px-3 py-1.5 rounded-full text-sm shadow-sm hover:shadow-md transition"
          >
            <span>{ingredient}</span>

            <button
              onClick={() => removeIngredient(ingredient)}
              className="opacity-70 group-hover:opacity-100 hover:text-red-200 transition"
            >
              ✕
            </button>
          </div>
  ...
  <div className="space-y-6">
    ...
    {isSearching ? (
      ...
      <div className="bg-white/90 backdrop-blur rounded-[28px] shadow-xl border border-white/40 p-12 text-center">
        ...
        <h3 className="text-2xl font-black text-[#2f3c33] mb-2">
          No Recipes Found
        </h3>
        <p className="text-gray-500">
          Try different ingredients or let AI suggest combinations.
        </p>
      </div>
    ) : (
...
{!dish.image_url && (
  <div className="h-2 w-24 rounded-full bg-gradient-to-r from-yellow-400 to-orange-400 mb-5" />
          ...
          {/* TITLE */}
          <h3 className="text-2xl font-black text-[#2f3c33] group-hover:text-[#44624a] transition">
            {dish.name}
          </h3>

          {/* DESCRIPTION */}
          <p className="text-gray-600 mt-2 mb-5 leading-relaxed">
            {dish.description}
          </p>
